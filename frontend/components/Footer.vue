        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-3 md:gap-8 py-10 max-sm:max-w-sm max-sm:mx-auto gap-y-8">
                <div class="col-span-full mb-10 lg:col-span-2 lg:mb-0">
                    <a href="https://expertresumes.in/"  class="flex justify-center font-bold lg:justify-start">
                        Expert Resumes
                    </a>
                    <p class="py-8 text-sm text-gray-500 lg:max-w-xs text-center lg:text-left">Trusted in more than 10 countries & 5000 customers. Have any query ?</p>
                    <NuxtLink to="/contact"  class="py-2.5 px-5 h-9 block w-fit bg-indigo-600 rounded-full shadow-sm text-xs text-white mx-auto transition-all  duration-500 hover:bg-indigo-700 lg:mx-0">
                        Contact us
                    </NuxtLink>
                </div>
                <!--End Col-->
                <!-- <div class="lg:mx-auto text-left ">
                    <h4 class="text-lg text-gray-900 font-medium mb-7">Expert Resumes</h4>
                    <ul class="text-sm  transition-all duration-500">
                        <li class="mb-6"><NuxtLink  to="/home" class="text-gray-600 hover:text-gray-900">Home</NuxtLink></li>
                        <li class="mb-6"><NuxtLink to="/services"  class=" text-gray-600 hover:text-gray-900">Services</NuxtLink></li>
                        <li class="mb-6"><NuxtLink  to="/contact" class=" text-gray-600 hover:text-gray-900">Contact</NuxtLink></li>
                        <li><NuxtLink  to="about" class=" text-gray-600 hover:text-gray-900">About Us</NuxtLink></li>
                    </ul>
                </div> -->
                <!--End Col-->
                <!-- <div class="lg:mx-auto text-left ">
            ...
            <div class="py-7 border-t border-gray-200">
                <div class="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
                    <span class="text-sm text-gray-500 ">©<a href="https://expertresumes.in/">Expert Resumes</a> 2024, All rights reserved.</span>
                    <div class="flex mt-4 space-x-4 sm:justify-center lg:mt-0 ">
                        ...
                        <a href="https://www.instagram.com/expertresumes/"  class="w-9 h-9 rounded-full bg-gray-700 flex justify-center items-center hover:bg-indigo-600">
